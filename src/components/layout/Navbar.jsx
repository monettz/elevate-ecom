      ...
      >
        ...
        >
          ...
          <Link 
            ...
            onClick={() => setIsMobileMenuOpen(false)}
            className="block bg-primary pt-12 pb-8 px-6 relative overflow-hidden flex-shrink-0 rounded-br-[2.5rem] group"
          >
            <button 
            ...
            {user ? (
              <div className="flex flex-col items-start text-white">
                ...
                <div className="font-bold text-xl truncate w-full group-hover:underline">{user?.user_metadata?.first_name} {user?.user_metadata?.last_name}</div>
                <div className="text-white/80 text-sm mt-0.5 truncate w-full">Click to view Profile</div>
              </div>
            ) : (
              <div className="flex flex-col items-start text-white">
                ...
                <div className="font-bold text-xl group-hover:underline">Sign In / Register</div>
                <div className="text-white/80 text-sm mt-0.5">Click here to sign in</div>
              </div>
            )}
          </Link>
          ...
          <div className="flex-1 overflow-y-auto py-6 px-4 custom-scrollbar bg-white">
            ...
            <div className="space-y-1">
              <h3 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider px-3 mb-3">Help & Support</h3>
